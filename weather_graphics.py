...
icon_font = ImageFont.truetype("./meteocons.ttf", 128)
...
class Weather_Graphics:
    ...
    def display_weather(self, weather):
        ...
        self._wind = f"{(wind_speed*1.6):.1f} mi/hr from {wind_dir}°"
    ...
    def update_display(self):
        ...
        # Draw the wind
        (font_width, font_height) = medium_font.getsize(self._wind)
        draw.text(
            ((self.display.width - font_width)/2, font_height*2), self._wind, font=self.medium_font, fill=BLACK,
        )
